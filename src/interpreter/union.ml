...
class unionHash (left : AlgebraTypes.feed_interface) (right : AlgebraTypes.feed_interface) =
  object(self)
...
class unionSort (left : AlgebraTypes.feed_interface) (right : AlgebraTypes.feed_interface) =
